...
enum HirNodeKind
{
    ...
    // Expressões
    IntLit, FloatLit, StringLit, BoolLit, CharLit, NullLit, ArrayLit, StructLit, LongLit,
...
{
    int value;
    this(int v, Type t) { kind = HirNodeKind.IntLit; value = v; type = t; }
}

class HirLongLit : HirNode
{
    long value;
    this(long v, Type t) { kind = HirNodeKind.LongLit; value = v; type = t; }
}
...
{
    string funcName;
    bool isVarArg, isOrnVarArgs, isExternalCall, isRef;
    int isVarArgAt;
    HirNode[] args;
