...
enum MirOp
{
    ...
    FAdd, FSub, FMul, FDiv, FNeg, Neg, Xor, FRem, SRem, BXor, BOr, BNot, BAnd,
    ...
    BitCast, SIToFP, FPToSI, FPExt, SExt, Trunc, FPTrunc, ZExt, UIToFP, FPToUI
}
...
struct MirValue
{
    ...
    static MirValue u32(uint v, Type t) { 
        return MirValue(true, false, v, 0.0, "", 0, t); 
    }

    static MirValue u64(ulong v, Type t) { 
        return MirValue(true, false, v, 0.0, "", 0, t); 
    }

    static MirValue u8(ubyte v, Type t) { 
        return MirValue(true, false, v, 0.0, "", 0, t); 
    }

    static MirValue u16(ushort v, Type t) { 
        return MirValue(true, false, v, 0.0, "", 0, t); 
    }

    static MirValue i16(short v, Type t) { 
        return MirValue(true, false, v, 0.0, "", 0, t); 
    }
    ...
    static MirValue i1(bool v, Type t) { 
    ...
    static MirValue i8(byte val, Type type = null) {
        MirValue v;
        v.isConst = true;
        v.constInt = val;
        v.type = type;
