...
class CallExpr : Node
{
    ...
    Node[] args;
    int isVarArgAt;
    bool isExternalCall, isIndirectCall, isRef, isTemplate, isVarArg, isOrnVarArgs;
...
class FuncDecl : Node
{
    ...
    BlockStmt body;
    FuncArgument[] args;
    bool isVarArg, noMangle, isOrnVarArgs;
    int isVarArgAt;
    bool isExtern = true;
    ...
    this(string name, ref FuncArgument[] args, Node[] body, TypeExpr type, Loc loc, bool isVarArg, 
        bool isExtern = false, bool noMangle = false, bool isOrnVarArgs = false)
    {
        ...
        this.isOrnVarArgs = isOrnVarArgs;
        if (isVarArg)
